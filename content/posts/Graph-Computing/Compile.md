...
lastmod: 2024-03-27T23:51:03+08:00
tags:
categories:
  - Graph-Computing
weight: 0
...
[如何评价MLIR项目中Linalg Dialect的设计思想？](https://www.zhihu.com/question/442964082) 各种回答中，有两点思想对于理解 MLIR 有一定帮助：
...
从 MLIR 提供的原生 Dialect convert (官方说法是 standard dialect) 到 LLVM Dialect 的相关介绍可以参考 "[Conversion to the LLVM Dialect](https://fuchsia.googlesource.com/third_party/llvm-project/+/refs/tags/llvmorg-11.0.0-rc5/mlir/docs/ConversionToLLVMDialect.md)"
